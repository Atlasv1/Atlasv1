...
local serv = win:Server("ggx", "")

game.StarterGui:SetCore("SendNotification", {Title = "ggx", Text = "script creator -lui", Icon = "rbxassetid://505845268", Duration = 9, Button1 = "Alright!"})
...
text = "ggx is god [made by gg.Naw]" say()
end)
        ...
        elseif enabled and (spyOnMyself==true or p~=player) then
            ...
            if hidden and enabled then
                if public then
                    ...
                    privateProperties.Text = "{ggx} [".. p.Name .."]: "..msg
                    StarterGui:SetCore("ChatMakeSystemMessage",privateProperties)
                end
            end
        end
